{%- macro get_facebook_ads_insights_region__child_source(table_name) -%}
...
{%- set available_columns = adapter.get_columns_in_relation(source('facebook_raw','ads_insights_'~table_name)) | map(attribute='name') | map('lower') | list -%}
